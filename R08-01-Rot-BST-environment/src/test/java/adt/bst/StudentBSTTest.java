...
public class StudentBSTTest {
	...
	public void testRemove() {
		...
		tree.remove(232);
		order = new Integer[] { -40, -34, 0, 2, 5, 12, 23, 67, 76};
		assertArrayEquals(order, tree.order());
		
		tree.remove(67);
		order = new Integer[] { -40, -34, 0, 2, 5, 12, 23, 76};
		assertArrayEquals(order, tree.order());
		
		tree.remove(-34);
		order = new Integer[] {-40, 0, 2, 5, 12, 23, 76};
		assertArrayEquals(order, tree.order());
		
		tree.remove(5);
		order = new Integer[] {-40, 0, 2, 12, 23, 76};
		assertArrayEquals(order, tree.order());
		
		tree.remove(12);
		order = new Integer[] {-40, 0, 2, 23, 76};
		assertArrayEquals(order, tree.order());
